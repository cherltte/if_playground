...
// int rowNum = 6;
// int colNum = 6;
// int max_height = 38; // led height
// int max_bright = 255;
// int height_divider = 3;
// int bright_divider = 3;
// int [][] ledHeight = new int [rowNum][colNum];
// int [][] ledBright = new int [rowNum][colNum];
// PVector [][] win_field_pos_c = new PVector [rowNum][colNum];
...
public void sendData()
{
        if (sendingPackets != 0)
        {
                ...
                {
                        //24-47 \uc74c\uacc4 \ubc94\uc704
                        String [] _note = {"48", "52", "55", "60", "64", "67", "72", "76", "79", "84", "88", "91"};
                        String _module = ""+_m[k];
...
public void actionTriggered(int _indx, int _triggered_from)
{
        ...
        case (2):
                ...
                String [] _note = {"47", "50", "55", "59", "62", "67", "71", "74", "79", "84", "86", "91"};
...
public void shot_led(int m){
        ...
        if (shot[m]) {
                ...
                // }
                // if(m_ledBar_status[m][var_ledBar_maxHeight] != _pre_maxHeigh[m] && m_ledBar_status[m][var_ledBar_maxHeight] == 1 ) {
                //         m_ledBar_status[m][var_ledBar_maxHeight] = 99;
                //         println("Asdf");
                // }
                // //get max_height();
                ...
                // _pre_maxHeigh[m] = m_ledBar_status[m][var_ledBar_maxHeight];
...
public void set_lives()
{
        ...
        float _minSize = 40;
        float _maxSize = 50;
        PVector [] _lives = new PVector [NUM_LIVES];
        //get random Numbers
        if(NUM_LIVES == 1)
        {
...
public void set_var_gui(){
        ...
        for(int i = 0; i < NUM_STRIPS; i++)
        {
                ...
                bar_colorSetAll[i] = color(i+_colorStart+ _colorRange*i, 255, 100);
                // println(bar_colorSetAll[i]);
        }
        popStyle();
        ...
        //window01 pannel basic
        win01_pd                 = 5;
        win01_init_h             = height/2+100;
        //window for module selector
        win_module_selector_x    = 75;
        win_module_selector_y    = 20;
        win_module_selector_w    = 25;
        win_module_selector_h    = 25;
        win_module_selector_sp   = 12;
        //window for waveBox
        win_waveBox_sp           = 20;
        win_waveBox_x            = 160;
        win_waveBox_y            = 80;
